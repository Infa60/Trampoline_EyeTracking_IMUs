...
def get_data_at_same_timestamps(
    ...
    """
    Get the corresponding orientation of the athlete and the gaze orientation for each movement.
    This function first separate the trial in the movement composing it.
    Then the data is interpolated to have both data at the same instants in time.
    """
